      ...
      <div className="row m-2"> */}
        {items.map((item) => {
          return (
            ...
            //   <div className="card shadow-sm w-100" style={{ minHeight: 250 }}>
            ...
            //       <hr></hr>
            //       <span className="card-text">Dayamayee Khan</span> |
            //       <span className="card-text"> khan_dayamayee@rice.info</span> |
            //       <span className="card-text"> male</span> 
            //     </div>
            //   </div>
            // </div>
